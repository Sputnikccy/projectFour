    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                <input name="keywords" placeholder="Search for artists, venues or events" type="text" />

                <label>country code</label>
                <input placeholder="ie, CA / US / GB" type="text" />
                    ...
                    events.map((eventObject) => {
                        return (
                            ...
                            <li className="eventCard" key={eventObject.id}>
                                ...
                                <a href={eventObject.url} target="_blank">buy tickets</a>
